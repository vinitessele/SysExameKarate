...
type
  TDM = class(TDataModule)
    ...
    FDQAvKata: TFDQuery;
    FDQAvKataID: TIntegerField;
    FDQAvKataID_TECNICA: TIntegerField;
    FDQAvKataID_ALUNO: TIntegerField;
    FDQAvKataPOSICAO: TSingleField;
    FDQAvKataTECNICAS: TSingleField;
    FDQAvKataRITMO: TSingleField;
    FDQAvKataVISAO: TSingleField;
    FDQAvKataKIME: TSingleField;
    FDQAvKataDISPOSICAO: TSingleField;
    FDQAvKataZANCHIN: TSingleField;
    FDQAvKataID_EXAME: TIntegerField;
    FDQKumite: TFDQuery;
    FDQKumiteID: TIntegerField;
    FDQKumiteID_TECNICA: TIntegerField;
    FDQKumiteID_ALUNO: TIntegerField;
    FDQKumiteID_EXAME: TIntegerField;
    FDQKumitePOSICAO: TSingleField;
    FDQKumiteTECNICAS: TSingleField;
    FDQKumiteDISTBASE: TSingleField;
    FDQKumiteDISTGOLPE: TSingleField;
    FDQKumiteDIRECAO: TSingleField;
    FDQKumiteKYO: TSingleField;
    FDQKumiteJITSU: TSingleField;
    FDQKumiteDEFESA: TSingleField;
    FDQKumiteCONTRAATAQUE: TSingleField;
    FDQKumiteVISAO: TSingleField;
    FDQKumiteKIME: TSingleField;
    FDQKumiteDISPOSICAO: TSingleField;
    FDQKumiteZANCHIN: TSingleField;
    FDQKumiteATAQUE: TSingleField;
